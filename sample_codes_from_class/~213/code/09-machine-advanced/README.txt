...
hexify.c
hexify
	Program to convert hex sequence on standard input into a string
	Useful for generating exploits

smash-hex.txt
	Hex representation of stack smashing exploit
	cat smash-hex.txt | ./hexify | ./bufdemo-nsp

demos.txt demos.pdf
        Description of the demos that can be run with the provided programs
